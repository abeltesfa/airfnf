...
def seed_cars():
    ...
    car3=Car(userId=3, make='Honda', model='S2000', carYear=2009, city='Fairfax', state='VA', country='USA', description='The 2009 Honda S2000 ranks high performance and one of the best sports cars in its class', price=210.00)
    ...
    car5=Car(userId=4, make='Porsche', model='911 Carrera', carYear=2022, city='New York', state='NY', country='USA', decription='The 2022 Porsche 911 Carrera ranks highly among luxury sports cars thanks in part to its enticing acceleration, standard-setting handling, and impeccable quality.', price=333.33)
